...
class="form-inline well" method="post" action="InsertionAutorisationTonnage">
  <p>&nbsp;</p>
  <table width="510" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0">Enregistrement Autorisation Tonnage Eaux et Foêts</td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="241" align="right" bgcolor="#D0D0D0">Quantité autorisée pour l'année <span class="red"> <%=year %>*</span></td>
      <td width="269" bgcolor="#D0D0D0"><input required="true" name="qt" type="text" id="qt" size="20"  placeholder="tonnage" />
      tonnes</td>
    </tr>
    <tr>
...
%>
  <tr>
    ...
    <td align="center" bgcolor="#F1F1F1"><strong><%=dest.getDepartement().getNomdepartement() %></strong></td>
