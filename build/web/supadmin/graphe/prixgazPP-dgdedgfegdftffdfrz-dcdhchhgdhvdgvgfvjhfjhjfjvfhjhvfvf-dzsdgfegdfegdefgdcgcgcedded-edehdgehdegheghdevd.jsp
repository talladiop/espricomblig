...
<table>
	<caption>Inventaire stocks Gaz du mois de <%=month %><%="/" %><%=year%> pour Département concernés</caption>
       <thead>
		...
		<tr>
			<td width="106"></td>
			<th width="79" scope="col">TAMBA</th>
			<th width="94" scope="col">St-LOUIS</th>
			<th width="75" scope="col">MBACKE</th>
			<th width="92" scope="col">KAOLACK</th>
			<th width="98" scope="col">DIOURBEL</th>
			<th width="81" scope="col">MATAM</th>
                        <th width="79" scope="col">MBOUR</th>
                        <th width="65" scope="col">Dakar</th>
         </tr>
	</thead>
	<tbody>
		<tr>
