...
<div id="page">
	...
	<div id="content">
		<div class="post">
		  <h2 class="title"><b>Login Administrateur R&eacute;gional</b></h2>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
	    <p class="date">&nbsp;</p>
			<div class="entry">
			  ...
			  <p>                
			  <form id="form" name="form" method="post" action="LoginAdminRegion">
  	  <p>
  	    <% 
	...
	%>
  	  ...
  	  <table  class="form-inline well" width="310" border="0" align="center" cellpadding="0" cellspacing="0">
  	    ...
  	    <tr>
  	      <td width="90" bgcolor="#D0D0D0"><label for="login">Login</label></td>
