...
<p>
  ...
  <!-- start page --></p>
<form class="form-inline well" id="form1" name="form1" method="post" action="InsertionInventaireStockgaz">
  <p>&nbsp;</p>
  <table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0">SUIVI INVENTAIRE STOCK GAZ Département <span class="bleu"><%=cptcl.getDepartement().getNomdepartement() %></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" bgcolor="#D0D0D0">Enregistrement Stock Type Gaz <span class="red">*</span></td>
    ...
    <tr>
      ...
      <td bgcolor="#D0D0D0"><input name="qt" type="text" id="qt" size="20" required="true" /></td>
    </tr>
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0"><input type="submit" name="button" id="button" value="Inserer" />
    ...
    <tr>
      <td colspan="2" bgcolor="#D0D0D0">NB : La quantité insérée doit être en chiffre. Ex : 3456</td>
    </tr>
  </table>
</form>
<p>&nbsp;</p>
