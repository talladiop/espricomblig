...
<div id="page">
	...
	<div id="content">
		<div class="post">
		  <h2 class="title"><b>Login Enquéteur</b></h2>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
	    <p class="date">&nbsp;</p>
			<div class="entry">
			  ...
			  <p>                
			  <p>                
			  <form id="form" name="form" method="post" action="LoginAdministrateur">
  	  <p>
  	    <% 
	...
	%>
  	  ...
  	  <table  class="form-inline well" width="300" border="0" align="center" cellpadding="0" cellspacing="0">
  	    <tr>
  	      <td bgcolor="#D0D0D0"><label for="login">Login</label></td>
  	      <td bgcolor="#D0D0D0"><input  required="true" name="login" type="text" id="login" size="20" /></td>
        </tr>
  	    <tr>
  	      <td bgcolor="#D0D0D0"><label for="pwd">Mot de passe</label></td>
  	      <td bgcolor="#D0D0D0"><input  required="true" name="pwd" type="password" id="pwd" size="20" /></td>
        </tr>
  	    <tr>
