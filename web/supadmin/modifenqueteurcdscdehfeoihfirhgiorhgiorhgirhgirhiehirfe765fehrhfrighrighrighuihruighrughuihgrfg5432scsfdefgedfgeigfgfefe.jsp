...
%>
      <td colspan="2" align="center" bgcolor="#D0D0D0">Modification  Enquéteur</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#D0D0D0"><input name="nom" type="text" id="nom" value="<%=ef.getNomenqueteur() %>" size="20" required="true" /></td>
    </tr>
    <tr>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" align="center" bgcolor="#EEEEEE">Liste de vos enquéteurs</td>
  </tr>
  <tr bgcolor="#D0D0D0">
    ...
    <td bgcolor="#D0D0D0"><div align="center"><strong><span class="feature-title">Département de l'enquéteur</span></strong></div></td>
...
%>
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><strong><span class="feature-title">
      ...
      <a href="enqueteurcdscdehfeoihfirhgiorhgiorhgirhgirhiehirfe765fehrhfrighrighrighuihruighrughuihgrfg5432scsfdefgedfgeigfgfefe.jsp?3456kjuylisteby453juyt876=<%=dest.getIdenqueteur() %>activer=<%=dest.getIdenqueteur() %>"><img src="images/interdit.jpg" alt="" width="20" height="16" border="0" /></a>
      <%}%>
    </span></strong></td>
    <td align="center" bgcolor="#FFFFFF"><strong><span class="feature-title">
      <% if (dest.getEtatcompte().equalsIgnoreCase("1")) {%>
      <a href="enqueteurcdscdehfeoihfirhgiorhgiorhgirhgirhiehirfe765fehrhfrighrighrighuihruighrughuihgrfg5432scsfdefgedfgeigfgfefe.jsp?3456kjuylisteby453juyt876=<%=dest.getIdenqueteur() %>suspend=<%=dest.getIdenqueteur() %>"><img src="images/activer.jpg" alt="" width="20" height="16" border="0" /></a>
      <%}%>
    </span></strong></td>
  </tr>
  <%
