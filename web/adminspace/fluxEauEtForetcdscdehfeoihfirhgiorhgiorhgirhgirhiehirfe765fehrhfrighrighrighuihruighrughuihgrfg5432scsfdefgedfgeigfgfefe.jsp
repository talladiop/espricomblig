...
<p>
  ...
  <!-- start page --></p>
<form id="form1" 
class="form-inline well" name="form1" method="post" action="IsertionEnquetefluxEauxEtForet">
  <p>&nbsp;</p>
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        List<Eauxforet> eauList = service.eauetforetServiceDao.findAll();
          for(Eauxforet ea : eauList)
           { 
     if(ea.getDepartement().getIDdepartement().equals(cptcl.getDepartement().getIDdepartement()))
         {
            ideau = ea;
...
%>
    ...
    <tr>
      <td align="right" bgcolor="#D0D0D0">Produit Ligneux <span class="red">*</span></td>
      <td bgcolor="#D0D0D0"><select  required="true" name="produit" id="produit">
        <%         
                         //intentiation objet
			 ProduitCl prodeau=new ProduitCl();
    ...
    <tr>
      ...
      <td bgcolor="#D0D0D0"><input  required="true" name="datev1" type="text" id="dateDebut" onFocus="view_microcal(true,dateDebut,microcal,-1,0);" onBlur="view_microcal(false,dateDebut,microcal,-1,0);" onKeyUp="this.style.color=testTypeDate(this.value)?'black':'red'" value="<%=day+"/"+month+"/"+year%>" maxlength="10"/></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#D0D0D0">Quantité sortie<span class="red">*</span></td>
      <td bgcolor="#D0D0D0"><input name="qts" type="text" id="qts" size="20" required="true" /></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#D0D0D0">Date sortie<span class="red">*</span></td>
      <td bgcolor="#D0D0D0"><input  required="true" name="datev2" type="text" id="dateDebut2" onFocus="view_microcal(true,dateDebut,microcal,-1,0);" onBlur="view_microcal(false,dateDebut,microcal,-1,0);" onKeyUp="this.style.color=testTypeDate(this.value)?'black':'red'" value="<%=day+"/"+month+"/"+year%>" maxlength="10"/></td>
    </tr>
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" align="center" bgcolor="#D0D0D0"><input type="submit" name="button" id="button" value="Enregistrer" />
        ...
        <input name="ideauforet" type="hidden" id="ideauforet" value="<%=ideau.getIdEauxforet() %>"></td>
    </tr>
    <tr>
